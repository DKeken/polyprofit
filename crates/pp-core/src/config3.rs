...
mod tests {
    ...
    fn valid_config() -> Config {
        Config {
            ...
            asset_definitions: vec![AssetDef {
    ...
    fn daily_loss_limit_positive_fails() {
        ...
        assert!(
            err.to_string()
                .contains("daily_loss_limit must be negative")
        );
    }
    ...
    fn daily_profit_cap_zero_fails() {
        ...
        assert!(
            err.to_string()
                .contains("daily_profit_cap must be positive")
        );
    }
    ...
    fn starting_balance_zero_fails() {
        ...
        assert!(
            err.to_string()
                .contains("starting_balance must be positive")
        );
    }
